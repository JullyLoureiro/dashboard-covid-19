                    ...
                    <Card border="light" style={{ width: '95%', marginTop: 30 }}>
                        ...
                        <Card.Body style={{padding: '0.9rem'}}>
                            <Card.Text style={{textAlign: 'justify'}}>
                                <span style={{margin:15, textAlign: 'justify', marginBottom: 20}}>Apesar de não termos ainda uma forma de tratamento oficial e testada para o COVID-19, nós podemos seguir algumas regras básicas:</span>
